...
public abstract class Car implements Movable {
    ...
    private double xPos;
    private double yPos;
    private RenaultMagnum renaultMagnum;
    ...
    public void setCarTransport(RenaultMagnum renaultMagnum) {
        this.renaultMagnum = renaultMagnum;
    }

    public void removeFromTransport (RenaultMagnum renaultMagnum) {
        if (this.renaultMagnum == renaultMagnum) {
            xPos += RenaultMagnum.MAX_DISTANCE;
            this.renaultMagnum = null;
        }
    }

    private void transportPositionSync(){
        xPos = renaultMagnum.getxPos();
        yPos = renaultMagnum.getyPos();
    }
